...
public abstract class PaginatedGui<P extends Plugin, V> extends AbstractGui<P> {
    ...
    public PaginatedGui(P plugin, GuiListener listener, Player player, Collection<V> values, int previousPos, int nextPos) {
        super(plugin, listener, player);
    ...
    public PaginatedGui(P plugin, GuiListener listener, Player player, AbstractGui<P> previousInventory, Collection<V> values, int previousPos, int nextPos) {
