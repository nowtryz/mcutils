...
public abstract class AbstractGui<P extends Plugin> implements Gui {
    ...
    public AbstractGui(P plugin, GuiListener listener, Player player) {
    ...
    public AbstractGui(P plugin, GuiListener listener, Player player, Gui previousInventory) {
    ...
    public final void open() {
        ...
        MCUtils.runOnPrimary(this.plugin, () -> this.player.openInventory(inventory));
        this.listener.register(this, this.inventory);
    }
